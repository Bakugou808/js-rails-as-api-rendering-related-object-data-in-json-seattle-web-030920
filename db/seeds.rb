...
sighting_a = Sightin.create(bird: bird_a, location: location_b)
sighting_b = Sightin.create(bird: bird_b, location: location_a)
sighting_c = Sightin.create(bird: bird_c, location: location_a)
sighting_d = Sightin.create(bird: bird_d, location: location_c)
sighting_e = Sightin.create(bird: bird_a, location: location_b)